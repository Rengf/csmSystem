      ...
      lists: [
        {
          ...
          icon: "&#xe6ac;",
          faup: "&#xe638;",
          sublists: [{ title: "首页", icon: "&#xeb0b;", url: "/admin" }]
        },
        {
          title: "报表管理",
          icon: "&#xe636;",
          faup: "&#xe638;",
          sublists: [
            { title: "访问统计", icon: "&#xeb0b;", url: "/admin/report" }
          ]
        },
        {
          title: "用户管理",
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "用户列表", icon: "&#xeb0b;", url: "/admin/userlist" },
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "文章列表", icon: "&#xeb0b;", url: "/admin/articlelist" },
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "分类列表", icon: "&#xeb0b;", url: "/admin/categorylist" },
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "添加商品", icon: "&#xeb0b;", url: "/admin/addgoods" },
            { title: "商品列表", icon: "&#xeb0b;", url: "/admin/goodslist" }
          ]
        },
        {
          title: "进货管理",
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "添加商家", icon: "&#xeb0b;", url: "/admin/addsupplier" },
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "添加订单", icon: "&#xeb0b;", url: "/admin/orderlist" },
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "添加物流", icon: "&#xeb0b;", url: "/admin/addgoods" },
        ...
        },
        {
          ...
          faup: "&#xe638;",
          sublists: [
            { title: "评论列表", icon: "&#xeb0b;", url: "/admin/commentlist" },
