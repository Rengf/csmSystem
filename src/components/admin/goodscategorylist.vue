  ...
  <div class="category">
    <div class="categorybox">
      <div class="somebtn">
        ...
        <search-box @searchmsg="searchcategory"></search-box>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(category,index) in categorylist" :key="index">
              ...
              <td>
                <button @click="deletecategory(category.goods_type_id)">删除</button>
                <button>修改</button>
              </td>
            </tr>
          </tbody>
...
import { RECEIVE_CATEGORY_LIST } from "@/store/mutations-types";
export default {
  data() {
    return {
      showtips: false,
  ...
  methods: {
    ...
    deletecategory(id) {
      axios
        .post("http://localhost:3333/admin/deletecategory", {
          goods_type_id: id
        })
        .then(
          response => {
    ...
    searchcategory(searchmsg) {
      axios
        .post("http://localhost:3333/admin/searchcategory", {
          searchmsg: searchmsg
        })
        .then(
          response => {
